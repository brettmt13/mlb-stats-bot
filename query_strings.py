...
PARAMS_PLATE_Z = {'hfSea': urllib.parse.unquote('2023%7C'), 'hfGT': urllib.parse.unquote('R%7C'), 'chk_game_date_gt': 'on', 'chk_stats_plate_z': "on", 'game_date_gt': game_dt, 'game_date_lt': game_dt, 'sort_by': 'desc', 'player_type': 'pitcher', 'min_pitches': '10'}
